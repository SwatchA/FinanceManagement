...
function Dashboard() {
  ...
  useEffect(() => {
    //Note this point carefully also
    readDocs();
  }, []);
        ...
        <div class="row">
            ...
            <div class="card pb-4">
              <div class="card-body text-center">
                ...
                <Link
                  ...
                  className="btn btn-success mt-2 me-2 mb-0 h5"
                >
                  <i class="fa-solid fa-plus"></i> Add New Account
                </Link>
                <Link
                  to="/dashboard/viewAccounts"
                  className="btn btn-info mt-2 me-2 mb-0 h5 text-white"
                >
                  <i class="fa-solid fa-eye"></i> View All Accounts
                </Link>
                <hr />
                {isLoading ? (
                  <div className="row">
                  ...
                  <div className="my-4">{totalAccounts}</div>
                )}
              </div>
            </div>
          </div>
          <div class="col-12 col-lg-6 mt-2">
            <div class="card">
              <div class="card-body text-center">
                <h5 class="card-title ">
                  <i class="fa-solid fa-money-bill-1"></i> Transactions
                </h5>
                <hr />
                <Link
                  to="/dashboard/viewTransactions"
                  className="btn btn-info mt-2 me-2 h5 text-white"
                >
                  <i class="fa-solid fa-eye"></i> View All Transactions
                </Link>
                <hr />
                {isLoading ? (
                  <div className="row">
